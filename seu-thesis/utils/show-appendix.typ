...
#let show-appendix-bachelor(it, table-numbering: "A.1", image-numbering: "A-1", equation-numbering: "(A.1)") = {
...
#let show-appendix-degree(it, table-numbering: "A-1", image-numbering: "A-1", equation-numbering: "(A-1)") = {
  show: show-appendix-bachelor.with(table-numbering: table-numbering, image-numbering: image-numbering, equation-numbering: equation-numbering)
  it
}